...
const Category = ({ c }) => {
  ...
  return (
    <div
      className="group relative flex flex-col w-full sm:w-[calc(50%-0.5rem)] md:w-[calc(33.333%-0.667rem)] lg:w-[280px] xl:w-[300px] h-[160px] sm:h-[240px] md:h-[280px] rounded-2xl overflow-hidden bg-gradient-to-b from-gray-800 to-gray-900 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] cursor-pointer focus:outline-none focus:ring-4 focus:ring-green-500/50"
      onClick={handleStart}
    ...
    >
      ...
      <div className="relative flex flex-col justify-center flex-1 px-4 py-2 bg-gray-900">
        <h2 className="capitalize text-white text-sm md:text-xl font-bold mb-1 md:mb-2 truncate group-hover:text-green-400 transition-colors duration-300">
          {name}
        </h2>
